...
| `setup/` | Environment and contribution setup notes |
| `api/` | API contracts between frontend, backend, and AI engine |

## Index

| Document | Contents |
| --- | --- |
| [`api/phase1-health.md`](api/phase1-health.md) | Health and status endpoints across the three services |
